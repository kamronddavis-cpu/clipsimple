      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-3xl font-bold">ClipSimple</span>
          </Link>
          <h1 className="text-2xl font-bold mb-2">Welcome back</h1>
          <p className="text-gray-400">Login to continue editing</p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-dark-hover border border-dark-border rounded-lg py-3 pl-10 pr-4 focus:outline-none focus:border-primary transition"
        ...
        <p className="text-center text-gray-400 text-sm mt-6">
          ...
          <Link href="/auth/signup" className="text-primary hover:text-primary-hover font-semibold">
            Sign up
          </Link>
        </p>
      </div>
